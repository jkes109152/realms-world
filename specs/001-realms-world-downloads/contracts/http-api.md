...
**狀態**：已實作管理員驗證入口及最新範圍的列表、詳情、建立、step、status 與兌換路由；2026-09-15 依使用者明確指示開啟公開總開關，部署 Origin 為 https://realms.jkesbyebye.com。其餘完整管理、歷史及紀錄端點依任務清單待完成，本文同時記錄目標契約與已實作子集；部署與待驗項目見 [正式網域紀錄](../validation/domain.md)。
