...
首頁已提供管理員預覽：先用網站帳號登入，再回首頁查看已發布世界，按「下載最新世界」及「儲存最新 .mcworld」。每次重新建立下載均重新請求官方 latest。預覽使用受保護驗證路由；匿名公開 API 仍回 downloads_closed，且 Site 外層仍私人。使用者於 2026-09-14 回覆尚未匯入，遊戲匯入及最新內容確認仍需本人完成，不能將下載或 ZIP 檢查當作成功匯入。
